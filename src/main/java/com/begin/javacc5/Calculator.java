/* Generated By:JavaCC: Do not edit this line. Calculator.java */
  ...
  final public Exp function() throws ParseException {
    ...
    jj_consume_token(RC);
        {if (true) return new UnresolvedFunCall(name, args);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Exp ifStatement() throws ParseException {
    ...
    exp = expression();
               args.add(exp);
    jj_consume_token(RB);
       {if (true) return new UnresolvedFunCall("IF", Syntax.IF, args);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Exp expression() throws ParseException {
    ...
    case NE:
      ...
      case LT:
        jj_consume_token(LT);
        exp2 = term2();
                {if (true) return new UnresolvedFunCall("<", Syntax.Infix, new Exp[]{exp, exp2});}
        break;
      case LE:
        jj_consume_token(LE);
        exp2 = term2();
  ...
  final public Exp term2() throws ParseException {
    ...
    while (true) {
      ...
      case PLUS:
        ...
        exp2 = term();
            exp = new UnresolvedFunCall("+", Syntax.Infix, new Exp[]{exp, exp2});
        break;
      case MINUS:
  ...
  final public Exp factor() throws ParseException {
    ...
    case MINUS:
      jj_consume_token(MINUS);
      exp = primary();
        {if (true) return new UnresolvedFunCall("-", Syntax.Prefix, new Exp[] {exp});}
      break;
    default:
      jj_la1[9] = jj_gen;
      jj_consume_token(-1);
  ...
  final public Exp primary() throws ParseException {
    ...
    case NUMBER:
      jj_consume_token(NUMBER);
        {if (true) return Literal.createNumber(token.image);}
      break;
    case SINGLE_QUOTED_STRING:
    ...
    case DOUBLE_QUOTED_STRING:
      jj_consume_token(DOUBLE_QUOTED_STRING);
        {if (true) return Literal.createString(stripQuotes(token.image, DQ, DQ));}
      break;
    case VAR:
      jj_consume_token(VAR);
        {if (true) return new UnresolvedFunCall(token.image, Syntax.Var, new Exp[0]);}
      break;
    case LC:
      jj_consume_token(LC);
      exp = expression();
